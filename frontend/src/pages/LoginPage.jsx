...
export default function LoginPage() {
  ...
  const bgStyle = isDark
    ...
    : { background: 'linear-gradient(135deg, #FFF7ED 0%, #FFF0E4 50%, #F0F7FF 100%)' }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={bgStyle}>
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Card */}
        <div className="bg-white dark:bg-[#141414] border border-[#FFDCC8] dark:border-[#4a1a1a] rounded-3xl shadow-2xl overflow-hidden">

          {/* Tabs */}
          <div className="flex border-b border-[#FFDCC8] dark:border-[#4a1a1a]">
            {[
              ...
              <button key={val} onClick={() => switchTab(val)}
                className={`flex-1 flex items-center justify-center gap-2 py-4 text-sm font-bold transition-all ${
                  tab === val
                    ? 'text-[#FF6B6B] border-b-2 border-[#FF6B6B] bg-[#FFF0E4]/50 dark:bg-[#1a0f0f]/50'
                    : 'text-[#9CA3AF] dark:text-[#FF9999] hover:text-[#FF6B6B]'
                }`}>
                <Icon size={15} /> {label}
              </button>
            ))}
              ...
              <>
                ...
                <div>
                  <label className="text-[#6B7280] dark:text-[#FFB3B3] text-xs font-semibold uppercase tracking-wide mb-1.5 flex items-center gap-1.5">
                    ...
                    Okul E-Postası <span className="text-[#FF6B6B] font-bold normal-case text-xs">*zorunlu</span>
                  </label>
                  <div className="relative">
                  ...
                  <p className="text-[#B0B8C4] dark:text-[#5a1a1a] text-xs mt-1.5 flex items-center gap-1">
                    <GraduationCap size={11} className="text-[#4D96FF]" />
        ...
        {/* Geri dön */}
        <p className="text-center text-sm text-[#9CA3AF] dark:text-[#FF9999] mt-5">
          ← <button onClick={() => navigate('/')} className="font-semibold text-[#FF6B6B] hover:underline transition-colors">
            Ana sayfaya dön
          </button>
        </p>
      </div>
